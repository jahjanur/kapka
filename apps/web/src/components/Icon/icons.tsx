...
export const ICONS = {
  ...
  eyeOff: (
    <>
      <path d="M10.6 5.2A9.9 9.9 0 0 1 12 5c6.4 0 10 7 10 7a17.3 17.3 0 0 1-3.2 4.1M6.2 6.2A17.3 17.3 0 0 0 2 12s3.6 7 10 7a9.9 9.9 0 0 0 4-.8" />
  ...
  shieldCheck: (
    <>
      <path d="M12 22s8-3.8 8-10V5.3L12 2 4 5.3V12c0 6.2 8 10 8 10Z" />
